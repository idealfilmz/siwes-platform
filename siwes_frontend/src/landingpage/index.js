      ...
      <div className="relative z-10 flex flex-col h-full animate-fade-in">
        ...
        <div className="shadow-lg bg-white p-5 fixed left-0 right-0 top-0">
          <ul className="flex flex-row items-center justify-around">
            ...
            <li className="flex flex-row items-center m-2 p-2 hover:underline">
              <FaOptinMonster className="text-blue-500" /> A PLATFORM TO ENHANCE
              SIWESS ASSESSMENT
            </li>
            <li className="flex flex-row items-center m-2 p-2 hover:underline">
        ...
        <center>
          <div className="mt-32">
            <h3
              ...
              className="text-blue-800 text-4xl font-extralight m-1 p-1"
            >
              Welcome to SIWES Assessment platform
            </h3>
            <p style={{ wordSpacing: 2 }} className="text-blue font-semibold">
            ...
            <button
              ...
              className="shadow-lg p-2 pr-7 pl-7 rounded-xl text-gray-100 bg-green-600 m-3"
            >
              Signup
            </button>
            <button
              onClick={() => navigate("/nav")}
              className="shadow-lg p-2 pr-7 pl-7 bg-blue-500 rounded-xl text-gray-100 m-3"
            >
              Login
            </button>
          </div>
        ...
        <div className="flex flex-row justify-between p-3 m-4">
          {[
            ...
            },
            {
              ...
              content:
                "The Student Industrial Work Experience Scheme (SIWES) is an important part and a crucial component of the Nigerian educational curriculum, it is designed to bridge the gap between theoretical knowledge gained by the students in the classroom and the needed practical experience for the real-life work that students will be engaging with after leaving the school.",
            },
            {
            ...
            <main
              key={index}
              className="bg-white p-4 shadow-lg m-4 rounded-lg w-1/3"
            >
              <h2 className="font-serif text-center p-2 text-gray-500 text-2xl">
                {item.title}
              </h2>
